...
USE_MOCK_GOOGLE_PLACES = env.bool('USE_MOCK_GOOGLE_PLACES', default=not bool(GOOGLE_PLACES_API_KEY))
GOOGLE_PLACES_USE_NEW_API = env.bool('GOOGLE_PLACES_USE_NEW_API', default=True)
GOOGLE_PLACES_RATE_LIMIT_PER_SECOND = env.float('GOOGLE_PLACES_RATE_LIMIT_PER_SECOND', default=1.0)
GOOGLE_PLACES_MAX_RETRIES = env.int('GOOGLE_PLACES_MAX_RETRIES', default=3)
...
if not DEBUG:
    ...
    SECURE_HSTS_SECONDS = 31536000 if env.bool('DJANGO_SECURE_SSL_REDIRECT', default=True) else 0
